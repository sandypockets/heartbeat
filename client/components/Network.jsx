                        ...
                        <div key={interfaceItem['name']} className="mt-3 border-t border-white pt-3">
                          ...
                          <ul>
                            ...
                            {interfaceItem['flags']?.length > 0 ? (
                              interfaceItem['flags'].map(flag => <li className="font-mono list-disc ml-6">{flag}</li>)
                            ) : (
                          ...
                          <ul>
                            ...
                            {interfaceItem['addrs']?.length > 0 ? (
                              interfaceItem['addrs'].map(address => <li className="font-mono list-disc ml-6 text-sm">{address['addr']}</li>)
                            ) : (
